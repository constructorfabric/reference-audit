...
[article] bagrov2020multiscale  (cited)
    Multiscale structural complexity of natural patterns
    ids: doi:10.1073/pnas.2004976117
    ✓ exactly one match (high) — Matched a single work via openalex.
      matched: doi:10.1073/pnas.2004976117  (openalex)

[article] chan2019lenia  (cited)
    Lenia: Biology of Artificial Life
    ids: doi:10.25088/complexsystems.28.3.251
    ✓ exactly one match (high) — Matched a single work via semantic_scholar.
      matched: doi:10.25088/complexsystems.28.3.251  (semantic_scholar)
...
[inproceedings] plantec2023flow  (cited)
...
[inproceedings] soros2014identifying  (cited)
    Identifying Necessary Conditions for the Emergence of Open-Ended Evolution Through the Artificial Life World of Chromaria
    ids: (no identifier)
    ⚠ no DOI/arXiv id (will attempt DOI backfill)
...
[misc] kumar2024automating  (cited)
...
[article] wolf2018physical  (cited)
    Physical foundations of biological complexity
    ids: doi:10.1073/pnas.1807890115
    · 1 field formatting nit(s) (not mistakes; see field_findings)
    ✓ exactly one match (high) — Matched a single work via openalex.
      matched: doi:10.1073/pnas.1807890115  (openalex)
...
[inproceedings] faldor2024leniabreeder  (cited)
    Toward Artificial Open-Ended Evolution within Lenia using Quality-Diversity
    ids: doi:10.1162/isal_a_00827
    · 1 field formatting nit(s) (not mistakes; see field_findings)
    ✓ exactly one match (high) — Matched a single work via semantic_scholar.
      matched: doi:10.48550/arxiv.2406.04235  (semantic_scholar)

[misc] mordvintsev2022particle  (cited)
    Particle Lenia and the energy-based formulation
    ids: url:https://google-research.github.io/self-organising-systems/particle-lenia/
    ⚠ URL-only web artifact; liveness check is a later milestone

[inproceedings] zhang2018perceptual  (UNCITED)
...
[article] katsnelson2018towards  (cited)
    ...
    ids: doi:10.1088/1402-4896/aaaba4
    ✓ exactly one match (high) — Matched a single work via semantic_scholar.
      matched: doi:10.1088/1402-4896/aaaba4  (semantic_scholar)
...
[misc] lindeberg2008  (cited)
    Scale‐Space
    ids: doi:10.1002/9780470050118.ecse609  isbn:9780470050118
    · 1 field formatting nit(s) (not mistakes; see field_findings)
    ✓ exactly one match (high) — Matched a single work via semantic_scholar.
      matched: doi:10.1002/9780470050118.ecse609  (semantic_scholar)
...
[article] wolpert2007  (cited)
    ...
    · 1 field formatting nit(s) (not mistakes; see field_findings)
    ✓ exactly one match (high) — Matched a single work via semantic_scholar.
      matched: doi:10.1002/cplx.20165  (semantic_scholar)
...
[article] laughlin1  (cited)
    The Theory of Everything
    ids: doi:10.1073/pnas.97.1.28
    ✓ exactly one match (high) — Matched a single work via openalex.
      matched: doi:10.1073/pnas.97.1.28  (openalex)

[article] laughlin2  (cited)
    The Middle Way
    ids: doi:10.1073/pnas.97.1.32
    ✓ exactly one match (high) — Matched a single work via openalex.
      matched: doi:10.1073/pnas.97.1.32  (openalex)

[book] gavrilets2004  (cited)
...
[article] smith2008thermo  (cited)
    ...
    ids: doi:10.1016/j.jtbi.2008.02.010
    · 1 field formatting nit(s) (not mistakes; see field_findings)
    ✓ exactly one match (high) — Matched a single work via openalex.
      matched: doi:10.1016/j.jtbi.2008.02.010  (openalex)

[article] wilson1974  (cited)
    The renormalization group and the $ε$ expansion
    ids: doi:10.1016/0370-1573(74)90023-4
    · 1 field formatting nit(s) (not mistakes; see field_findings)
    ✓ exactly one match (high) — Matched a single work via openalex.
      matched: doi:10.1016/0370-1573(74)90023-4  (openalex)
...
UNRESOLVED \input/\include (citation coverage incomplete — 'uncited' below may be cited inside these):
    ...
    appendixB_protocols.tex
    appendixC_optimization_protocols
    appendixD_render_examples
    section3.tex
    section4.tex

UNCITED (in .bib, never \cite/\nocite — info — may be cited in missing includes):
    fu2023dreamsim, zhang2018perceptual

COMMENTED ENTRIES (informational — possible preprint/version twins):
    bagrov2024visual
